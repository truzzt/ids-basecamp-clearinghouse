...
use crate::model::constants::{KEYRING_DB, MONGO_COLL_DOC_TYPES, MONGO_COLL_MASTER_KEY, MONGO_ID, MONGO_PID};
...
impl KeyStore {
    ...
    pub async fn update_document_type(&self, doc_type: DocumentType, id: &String) -> errors::Result<bool> {
        let coll = self.database.collection::<DocumentType>(MONGO_COLL_DOC_TYPES);
